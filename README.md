...
课程按轮次逐步制作：**一次对话只完成一轮详细课程**。现阶段每轮提交详细讲义与必要代码示例；收到“下一轮”后，才继续制作下一轮。练习和测试题等具备合适资源后再补充。
...
| 02 | [Frame / FPS / Time：把秒换算成可寻址的位置](02/readme.md) | ✅ 已完成 |
| 03 | Clip：存在于 DOM，不等于此刻可见 | ⏭ 下一轮 |
